...
class NursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nurse" do
    assert_difference("Nurse.count") do
      post nurses_url, params: { nurse: { ladder_level: @nurse.ladder_level, name: @nurse.name, team: @nurse.team } }
    end
  ...
  test "should update nurse" do
    patch nurse_url(@nurse), params: { nurse: { ladder_level: @nurse.ladder_level, name: @nurse.name, team: @nurse.team } }
